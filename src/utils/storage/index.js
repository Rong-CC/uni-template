/*
 * @Description: 公共的storeage
 * @Author: rongcheng
 * @@后台人员: xxx
 * @Date: 2022-10-24 19:55:24
 * @LastEditors: rongcheng
 * @LastEditTime: 2022-10-24 19:55:46
 */
...
const proxy = (state) => {
	...
	Object.keys(state).forEach((e) =>
		isArray(state[e]) || isObject(state[e]) ? (state[e] = proxy(state[e])) : ''
	)
