/*
 * @Description: 封装功能request
 * @Author: rongcheng
 * @@后台人员: xxx
 * @Date: 2022-10-24 14:12:09
 * @LastEditors: rongcheng
 * @LastEditTime: 2022-10-24 19:53:44
 */
...
export default function ({
	...
	return {
		...
		file(method, url, data, header, reqIntercept, resIntercept) {
			...
			let progressUpdateHandle
			const onProgressUpdate = (e) => (progressUpdateHandle = e) // progressUpdateHandle 监听上传进度变化回调，onProgressUpdate 监听上传进度变化方法
			return new Proxy(
				new Promise((resolve, reject) => {
					...
					this.interceptors.request
						...
						.then(async ({ header, body, cancel }) => {
							...
							requestTask.onProgressUpdate = onProgressUpdate(progressUpdateHandle) // 监听下载进度变化
